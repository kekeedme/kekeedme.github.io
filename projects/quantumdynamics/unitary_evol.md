...
subspace over which it is defined. Then it must retain the same norm at a later time $t$.(I have a demonstration of this [here](projects/Miscellaneous/slides/Prob_densisty_current_momentum.pdf))
